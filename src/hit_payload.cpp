...
Vector3i GDC_HitPayload::get_block_pos() const { return block_pos; }
void GDC_HitPayload::set_block_pos(const Vector3i &p_pos) { block_pos = p_pos; }

Vector3i GDC_HitPayload::get_normal() const { return normal; }
void GDC_HitPayload::set_normal(const Vector3i &p_normal) { normal = p_normal; }

int32_t GDC_HitPayload::get_block_id() const { return block_id; }
void GDC_HitPayload::set_block_id(int32_t p_id) { block_id = p_id; }